 ...
 *       Classification#SOURCE_RULE}. A best score of zero, or a tie for first place, yields {@link
 *       Taxonomy#UNKNOWN_TYPE}, source {@value Classification#SOURCE_UNKNOWN} — a guess would be
 *       worse than admitting the rules didn't recognise the document.
 * </ol>
 */
@Component
public class DocumentClassifier {
  ...
  private Classification classifyByRule(String title, String content) {
    ...
    if (bestScore == 0 || bestScoreCount > 1) {
      return unknownClassification();
    }
