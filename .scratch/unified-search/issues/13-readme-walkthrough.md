...
- [x] The brief's two examples and the fuzzy-name case appear as copy-pasteable requests with their actual responses
...
- [x] Deviations from the brief are listed, including the additional endpoints and the embedding input
...
- [x] The complexity is justified by the four failures it fixes (§0.1), in a paragraph a reviewer meets before the architecture, because the brief budgets 10 to 14 hours and this is more than that
